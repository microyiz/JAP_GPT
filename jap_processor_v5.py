...
class DocumentProcessor:
    ...
    def paper_revise(self, rows, filename):
        ...
        with open("prompt_one.txt", "r", encoding="utf-8") as file:
    ...
    def knowledge_point_analysis(self, rows, filename, sample_analysis):
        ...
        with open("prompt_two.txt", "r", encoding="utf-8") as file:
            prompt_content = file.read()
        prompt_two = ChatPromptTemplate.from_template(prompt_content) 
    ...
    def question_revise(self, rows, filename, max_iterations=5):
        ...
        with open("prompt_three_modified.txt", "r", encoding="utf-8") as file:
            prompt_content = file.read()
        prompt_three = ChatPromptTemplate.from_template(prompt_content) 
