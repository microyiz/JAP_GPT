...
class DocumentProcessor:
    ...
    def paper_revise(self, rows, material, mistake_count, filename):
        """
        ...
        prompt_one = ChatPromptTemplate.from_template(
                ...
                "Each question includes the student's incorrect choice and the correct answer and corresponding knowledge points.\n"
                "Based on these errors and the corresponding knowledge points, generate new practice questions targeting similar grammar or vocabulary points to help students strengthen their understanding.\n"
    ...
    def process(self, input_paper, correct_answers_path, sample_analysis):
        ...
        for filepath in glob.glob(os.path.join(self.input_folder, "*.docx")):
            ...
            self.paper_revise(' '.join(problem_list), material, mistake_count, filename)
...
def main():
    ...
    input_paper = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\JAP_GPT\\processed test paper with knowledge points\\Test 1 Question Paper.docx"
