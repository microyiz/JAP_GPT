...
class DocumentProcessor:
    def __init__(self, input_folder, output_folder, output_analysis_folder):
        """
...
def main():
    input_folder = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\student paper"
    output_folder = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\New Paper"
    output_mistakes_folder = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\Student Mistakes"
    output_analysis_folder = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\Knowledge Point Analysis"
    correct_answers_path = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\test 1 paper\\Test 1 Model Answer.docx"
    input_paper = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\test 1 paper\\Test 1 Question Paper.docx"
    ...
    sample_mistake_analysis = "C:\\Users\\刘宇\\OneDrive - CUHK-Shenzhen\\桌面\\基于大模型的学习平台开发\\template paper from CUHK\\Test1\\1155159595 Test 1_sample_mistakes_analysis.doc"
    

    checker = AnswerChecker(correct_answers_path, input_folder, output_mistakes_folder)
    checker.process_all_files()
    processor = DocumentProcessor(input_folder, output_folder, output_analysis_folder)
