...
def extract_ruby_and_modify_text(docx_path):
    ...
    modified_text = modified_text.replace("EQ \* jc2 \* \"Font:Yu Mincho\" \* hps10 \o\\ad(\s", " ")
...
# 主函数
def main():
    processed_material = "C:\\Users\\30998\\Desktop\\JAP_GPT\\template paper from CUHK\\TDLEG learning materials"
    grammar = "C:\\Users\\30998\\Desktop\\JAP_GPT\\template paper from CUHK\\TDLEG learning materials\\N4 Notes 文法.docx"
    vocabulary = "C:\\Users\\30998\\Desktop\\JAP_GPT\\template paper from CUHK\\TDLEG learning materials\\N4 Notes 語彙.docx"
